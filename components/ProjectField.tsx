...
// Pick a project from the canonical list, or add a new one inline.
...
export function ProjectField({
  ...
  const items = useStore((s) => s.projects);
  const addItem = useStore((s) => s.addProject);
      ...
      {adding && (
        <View style={styles.addRow}>
          <TextInput
            ...
            placeholder="Project name (e.g. Manatee)"
